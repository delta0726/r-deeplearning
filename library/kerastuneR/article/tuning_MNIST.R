...
# URL       : https://eagerai.github.io/kerastuneR/articles/MNIST.html
# ***************************************************************************************
...
main = function() {
  tuner <-
    conv_build_model %>%
      Hyperband(objective = 'val_accuracy',
                max_epochs = 8,
                factor = 2,
  ...
  mnist_train <-
    tensor_slices_dataset(list(tf$dtypes$cast(
